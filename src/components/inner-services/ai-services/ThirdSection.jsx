...
const PricingCards = () => {
  return (
    ...
    <h2 className="price-top-head text-center text-uppercase fw-bold">Pricing tiers</h2>
...
<header className="card__header d-block w-100 text-start">
          <div className="mb-3 w-20 h-20 rounded-full grid place-items-center bg-gray-100">
            <img src="../../assets/img/inner-service/service/Basic-plan-icon-main.png" alt="Free plan" className="w-14 h-14" />
          </div>
          <span className="block text-sm text-[#9ba6b0] font-medium mb-1 text-uppercase">Free plan</span>
...
<div className="price-wrap-content w-full h-full">
        <header className="card__header d-block w-100 text-start">
          <div className="mb-3 w-20 h-20 rounded-full grid place-items-center bg-gray-100">
            <img src="../../assets/img/inner-service/service/Professional-icon.png" alt="Professional plan" className="w-14 h-14" />
          </div>
          <span className="block text-sm text-[#9ba6b0] font-medium mb-1 text-uppercase">Most popular</span>
...
<div className="price-wrap-content w-full h-full">
        <header className="card__header d-block w-100 text-start">
          <div className="mb-3 w-20 h-20 rounded-full grid place-items-center bg-gray-100">
            <img src="../../assets/img/inner-service/service/Enterprise-icon.png" alt="Enterprise plan" className="w-14 h-14" />
          </div>
          <span className="block text-sm text-[#9ba6b0] font-medium mb-1 text-uppercase">For agencies</span>
